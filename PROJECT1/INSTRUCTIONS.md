...
![finding landscapes](./INSTRUCTIONS_images/LevelCreation/locating_landscapes.PNG "A screenshot of file structure, finding the landscape prefabs")
...
![landscape into scene](./INSTRUCTIONS_images/LevelCreation/premade_landscape.PNG "A screenshot of Scene Hierarchy containing landscape that was dragged into it.")
...
![your landscape](./INSTRUCTIONS_images/LevelCreation/your_landscape.PNG "A screenshot of the prefab "YourLandscape")

![landscape into scene](./INSTRUCTIONS_images/LevelCreation/yourlandscape_into_scene.PNG "A screenshot of Scene Hierarchy containing landscape that was dragged into it.")
...
![finding tilepalette](./INSTRUCTIONS_images/LevelCreation/finding_tilepalette.PNG)

![tilepalette_window](./INSTRUCTIONS_images/LevelCreation/tilepalette_window.PNG)
...
![prefab mode](./INSTRUCTIONS_images/LevelCreation/prefab_mode.PNG)

7. Now, click on the paint brush icon.

![paint brush](./INSTRUCTIONS_images/LevelCreation/paint_brush.PNG)
...
For example:
![select portion](./INSTRUCTIONS_images/LevelCreation/select_portion.PNG)
...
![paint scene](./INSTRUCTIONS_images/LevelCreation/paint_scene.PNG)
![eraser](./INSTRUCTIONS_images/LevelCreation/eraser.PNG)
...
![obstacle menu](./INSTRUCTIONS_images/LevelCreation/obstacle.PNG)
...
![end product](./INSTRUCTIONS_images/LevelCreation/example_endproduct.PNG)
...
![locating players](./INSTRUCTIONS_images/AddingMainCharacter/locating_players.PNG)
...
![player into scene](./INSTRUCTIONS_images/AddingMainCharacter/player_into_scene.PNG)
...
![player camera](./INSTRUCTIONS_images/AddingMainCharacter/player_camera.PNG)
...
![locating enemies](./INSTRUCTIONS_images/AddingEnemies/locating_enemies.PNG)

4. Select your favorite enemy, and drag them into the Scene Hierarchy.

![enemy into scene](./INSTRUCTIONS_images/AddingEnemies/enemy_into_scene.PNG)
...
![moving character](./INSTRUCTIONS_images/SettingUpSprites/moving_character.gif)
...
![boxcollider2d](./INSTRUCTIONS_images/SettingUpSprites/boxcollider2d.PNG)
...
![capsulecollider2d](./INSTRUCTIONS_images/SettingUpSprites/capsulecollider2d.PNG)
...
![Player Tag](./INSTRUCTIONS_images/SettingUpSprites/PlayerSprite/tag.PNG)

![Player Layer](./INSTRUCTIONS_images/SettingUpSprites/PlayerSprite/layer.PNG)
...
![locating menus](./INSTRUCTIONS_images/InGameMenusInterfaces/locating_menus.PNG)
...
![menu into scene](./INSTRUCTIONS_images/InGameMenusInterfaces/dragmenu.PNG)
...
![inactive](./INSTRUCTIONS_images/InGameMenusInterfaces/inactive.PNG)
...
![locating background](./INSTRUCTIONS_images/MainMenu/locate_background.PNG)
...
![edit background](./INSTRUCTIONS_images/MainMenu/image.PNG)
